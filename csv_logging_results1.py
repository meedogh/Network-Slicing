...
results_dir_train_results = f"{os.path.join(sys.path[0])}/sub_episodes_reward_test_inverse_reward_testtttt"
...
df.to_csv(f"{outlet_name[outlet_num]}sub_episodes_reward_test_inverse_reward_testtttt{method_name[outlet_num]}.csv",
          index=False)
