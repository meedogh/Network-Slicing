...
results_dir_train_results = f"{os.path.join(sys.path[0])}/sub_episodes_reward_2_m2_m1_2"
...
df.to_csv(f"{outlet_name[outlet_num]}sub_episodes_reward_2_m2_m1_2_t{method_name[outlet_num]}.csv",
          index=False)
