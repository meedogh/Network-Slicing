...
results_dir = os.path.join(sys.path[0],
                           'action_each_single_request_reward_method4_add_init_10_11_12_less_failure_less_reward_memory_filtering_60')
...
# prev_results_dec_weight = f"{os.path.join(sys.path[0])}//action_each_single_request_reward_method4_add_init_10_11_12_less_failure_less_reward_memory_filtering_60//"
