...
results_dir = os.path.join(sys.path[0],
                           'run_fifo_just_on_rush_hours_lr_0.001_03')
...
prev_decentralize_weights_path = os.path.join(prev_results_dec_weight, "run_fifo_just_on_rush_hours_lr_0.001_02/decentralized_weights/")
