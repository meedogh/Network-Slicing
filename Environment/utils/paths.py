...
results_dir = os.path.join(sys.path[0],
                           'sub_episodes_reward_2_m2_m1_2_more_training')
...
prev_results_3tanh_dir =f"/content/drive/MyDrive/network_slicing/results3_tanh/"
...
prev_results_dec_weight = f"/content/drive/MyDrive/network_slicing/sub_episodes_reward_2_m2_m1_2/"
