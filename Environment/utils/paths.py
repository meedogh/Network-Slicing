...
results_dir = os.path.join(sys.path[0],
                           'action_each_single_request_reward2_method2_repeat_periods_each_episode_retrain')
...
# prev_results_dec_weight = "C://Users//Windows dunya//PycharmProjects//pythonProject//Network-Slicing//action_each_single_request_reward2_method2_repeat_periods_each_episode"
