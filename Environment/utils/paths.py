...
results_dir = os.path.join(sys.path[0],
                           'run_rl_just_on_rush_hours_lr_0.001_ep_greedy12')
...
prev_results_3tanh_dir ="results3_tanh/results3_tanh"
...
prev_decentralize_weights_path = os.path.join(prev_results_dec_weight, "run_rl_just_on_rush_hours_lr_0.001_ep_greedy11/decentralized_weights/")
