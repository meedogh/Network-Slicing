...
def load_weigths_buffer(gridcell):
    ...
    for i in range(1):
        ...
        #     outlet.dqn.model.load_weights(os.path.join(prev_decentralize_weights_path, f'weights_0_50.hdf5'))
            # outlet.dqn.agents.fill_memory(outlet.dqn.agents.memory , os.path.join(prev_decentralize_memory_path, f'decentralize_buffer0_100.pkl'))
