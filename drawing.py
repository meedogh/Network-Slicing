...
def plot_metrics(*, titles, number_of_plots, file_path_to_save, metrics, plot_type):
      ...
      if plot_type == 'all':
            ...
            #       ax[1].plot(ranged_values_rl[:2700], end_to_end_delay_rl[:2700])
            ...
            if len(time_out_delay_fifo)>0:
                  ax.plot(ranged_values_fifo,time_out_delay_fifo)
                  legend_list.append('time out fifo')
...
time_out_delay_file_path_fifo = os.path.join("run_fifo_scenario_3_lr_0.001", "time_out_delay", "time_out_delay0.pkl")
...
time_out_delay_fifo = read_pickle_file(time_out_delay_file_path_fifo)
...
titles['end_to_end_title'] = 'End to End Delay Scenario 3 RL'
titles['serving_ratio_title'] = 'Serving Ratio Scenario 3 RL'
