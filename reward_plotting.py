...
outlet_num = 0
results_dir = os.path.join(sys.path[0],f"action_each_single_request_reward_method4_add_init_10_11_12_//reward_accumilated_decentralize//accu_reward{outlet_num}.pkl")
