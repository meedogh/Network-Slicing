...
outlet_num = 0
results_dir = os.path.join(sys.path[0],f"action_each_single_request_reward_method4_add_init_10_11_12_less_failure_0_10_m1_100//qvalue_decentralized_for_plotting//qvalue{outlet_num}.pkl")
