...
outlet_num = 0
results_dir = os.path.join(sys.path[0],f"action_each_single_request_repeat_periods_each_episode_retrain_larg_time_out_ranges_with_failure_method4_reward//reward_accumilated_decentralize//accu_reward{outlet_num}.pkl")
