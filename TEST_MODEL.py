...
model = build_model()
model.load_weights(
    f'{os.path.join(sys.path[0])}//action_each_single_request_reward_method4_add_init_10_11_12_no_protrization_less_failure_less_reward_test//decentralized_weights/weights_0_140.hdf5')
