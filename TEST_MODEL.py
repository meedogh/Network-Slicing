...
model = build_model()
model.load_weights(
    f'{os.path.join(sys.path[0])}//sub_episodes_reward_2_m2_m1_2_more_training//decentralized_weights/weights_0_20.hdf5')

# Calculate Q-values for each (x1, x2) pair (replace this with your actual Q-values)
x1_time_out = np.arange(2,12, 1)
current_capacity = 0.45
y1_bl = np.arange(40,55, 0.5)
pa = 2.54
