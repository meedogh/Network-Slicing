...
model = build_model()
model.load_weights(
    f'{os.path.join(sys.path[0])}//action_each_single_request_reward_method4_add_init_10_11_12_no_protrization_less_failure//decentralized_weights/weights_0_140.hdf5')

# Calculate Q-values for each (x1, x2) pair (replace this with your actual Q-values)
# x1_time_out = np.arange(2,23, 1)
# y1_current_capacity = np.arange(0.01, 10, 0.5)
# bl = 96.0
# pa = 2.54
...
#
x2_buffer_length = np.arange(95, 100, 1)
y2_current_capacity = np.arange(0.05, 5.05, 1)
tout = 2
pa2 = 3.54
