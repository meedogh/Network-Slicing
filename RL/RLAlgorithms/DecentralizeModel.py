...
class DecentralizeModel():
    def __init__(self, state_size = 5, action_size =2, activation_function = "relu", loss_function = "mse", optimization_algorithm = Adam,
                 learning_rate = 0.01, output_activation = "sigmoid", **kwargs):
